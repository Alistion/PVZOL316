...
from dal import get_all_users, get_arena_lineup, get_user_organisms, update_arena_lineup
...
class ArenaService:
        ...
        for org_id in lineup_str.split(","):
            ...
            if org_id_str and org_id_str in orgs_dict:
                ...
                safe_org = {
                    ...
                    "orid": str(
                        raw_org.get("orderId", 176)
                    ),  # 官方叫 orid 而不是 orderId
    ...
    def get_arena_list(username):
        ...
        owner_data = {"num": 5, "rank": my_rank, "organisms": owner_organisms}

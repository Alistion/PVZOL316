...
def build_user_xml(username):
    ...
    <root>
        ...
        <user id="{user['id']}" name="{user['username']}" charm="999" money="{money}" date_award="1" reward_daily="1" has_reward_cus="1" has_reward_once="1" has_reward_sum="1" has_reward_first="1" state="" rmb_money="{rmb}" open_cave_grid="16" wins="999" is_new="0" login_reward="1" invite_amount="0" use_invite_num="0" max_use_invite_num="10" lottery_key="99" banner_num="0" banner_url="" hasActivitys="1" face_url="" face="1" vip_grade="10" vip_etime="1893427200" vip_restore_hp="1" is_auto="1" serverbattle_status="3" IsNewTaskSystem="1" registrationReward="0" stone_cha_count="0" vip_exp="99999" >
